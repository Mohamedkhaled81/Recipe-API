"""
Becouse of this directory structure django will automaticaly detect this as a management command that will be run using manage.py
...
# BaseCommand has a check method that allows us to check the status of the database
