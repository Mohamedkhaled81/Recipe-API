...
from recipe.serializers import RecipeReadSerializer, RecipeReadDetailsSerializer
...
class PrivateRecipeAPITests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = create_user(
            name="Mohamed Khaled", email="test@example.com", password="123456test"
        )
    ...
    def test_retrieve_recipes_specific_to_uesr(self):
        ...
        other_user = create_user(
            name="MOMO", email="MOMOmMO@example.com", password="1234Testexample"
        )
    ...
    def test_full_update_fails(self):
        ...
        recipe = create_recipe(user=self.user, title="Original")
        patrial_update_payload = {"time_minutes": 25, "price": Decimal("9")}
        res = self.client.put(detail_url(recipe.id), patrial_update_payload)
